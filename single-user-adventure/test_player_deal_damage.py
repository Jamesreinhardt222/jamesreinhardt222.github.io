...
import io
from A01162209_1510_assignments.A3.combat import player_deal_damage


class TestPlayer_deal_damage(TestCase):
    @patch('builtins.input', return_value=1)
    @patch('A01162209_1510_assignments.A3.combat.roll_die', return_value=3)
    @unittest.mock.patch('sys.stdout', new_callable=io.StringIO)
    def test_player_deal_damage_but_not_kill_printed_output(self, mock_stdout, mock_input, mock_choice):
        demon = {"Health": 5}
    ...
    @patch('builtins.input', return_value=1)
    @patch('A01162209_1510_assignments.A3.combat.roll_die', return_value=3)
    def test_player_deal_damage_but_not_kill_return_value(self, mock_input, mock_choice):
    ...
    @patch('builtins.input', return_value=1)
    @patch('A01162209_1510_assignments.A3.combat.roll_die', return_value=6)
    def test_player_deal_damage_and_kill_enemy_return_value(self, mock_input, mock_choice):
    ...
    @patch('builtins.input', return_value=1)
    @patch('A01162209_1510_assignments.A3.combat.roll_die', return_value=3)
    def test_if_player_deal_damage_alter_enemy_stats(self, mock_input, mock_choice):
        enemy = {"Health": 5}
